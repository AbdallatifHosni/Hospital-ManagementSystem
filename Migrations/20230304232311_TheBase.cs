    ...
    public partial class TheBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DialysisUnits", x => x.DialysisUnitId);
                    table.ForeignKey(
                        name: "FK_DialysisUnits_Hospitals_HospitalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doctors_DialysisUnits_dialysisunitId",
                        column: x => x.dialysisunitId,
                        principalTable: "DialysisUnits",
                        principalColumn: "DialysisUnitId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Nurses_DialysisUnits_dialysisUnitId",
                        column: x => x.dialysisUnitId,
                        principalTable: "DialysisUnits",
                        principalColumn: "DialysisUnitId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_DialysisUnits_dialysisUnitId",
                        column: x => x.dialysisUnitId,
                        principalTable: "DialysisUnits",
                        principalColumn: "DialysisUnitId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dosage = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NTimes = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DialysisUnits_HospitalId",
                table: "DialysisUnits",
                column: "HospitalId");

            migrationBuilder.CreateIndex(
                name: "IX_Doctors_dialysisunitId",
                table: "Doctors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_dialysisUnitId",
                table: "Patients",
                column: "dialysisUnitId");
        }
